...
- [x] **P2-05 DI scope·graph·disposal** — application scope singleton과 명시적 child scope의 request/task ownership, dependency factory의 graph resolution·cycle rejection, reverse-order disposer와 Application shutdown disposal을 추가하고 contract test로 검증했다.
