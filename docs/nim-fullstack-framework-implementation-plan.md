...
| [-] | REQ-OPS-004 | P2 | email·flash·RSS/Atom·sitemap을 서버 렌더링용 독립 패키지로 제공한다. session key별 bounded FIFO·consume-once `FlashStore`, XML-escaped sitemap/RSS 2.0 renderer, Atom 1.0 feed/entry renderer를 추가했으며 email backend는 남아 있다. |
