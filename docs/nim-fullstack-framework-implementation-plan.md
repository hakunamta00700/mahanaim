...
| [-] | REQ-DATA-003 | P1 | SQLite migration artifact와 command runner의 up/down/status, 명시적 provider registry, metadata migration 생성과 schema diff/check을 제공한다. 실제 `db` CLI wiring·fixture/seed는 남아 있다. |
