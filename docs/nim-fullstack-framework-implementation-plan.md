...
| [-] | REQ-OPS-004 | P2 | email·flash·RSS/Atom·sitemap을 서버 렌더링용 독립 패키지로 제공한다. session key별 bounded FIFO·consume-once를 보장하는 `FlashStore`와 기본 in-memory adapter를 추가했으며 email/RSS/Atom/sitemap은 남아 있다. |
