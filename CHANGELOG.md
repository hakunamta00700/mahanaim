...
- PostgreSQL 16 live contract에서 serializable session의 typed `FOR UPDATE`/`FOR SHARE` row-lock 실행과 commit lifecycle을 검증하고, SQLite·aggregate lock의 fail-fast 경계를 유지했다.
